...
const ABILITY_DESC_IDLE =
  "Select one adjacent enemy piece to reveal its rank for 1.5 seconds.";
const ABILITY_DESC_ACTIVE =
  "Tap a highlighted adjacent enemy to reveal their rank, or tap elsewhere to cancel.";
...
const styles = StyleSheet.create({
  ...
  iconPillActive: { borderColor: "#A0B840", backgroundColor: "#252E0A" },
  iconPillCooldown: { borderColor: "#2A2E18", backgroundColor: "#0C0E06" },
  iconText: {},
  abilityName: {
    color: "#A0B840",
  ...
  abilityNameActive: { color: "#C8E050" },
  abilityNameCooldown: { color: "#3A4018" },
  readyPill: {
  ...
  descActive: { color: "#C8E050", opacity: 0.9 },
  descCooldown: { color: "#3A4A18", opacity: 0.8 },
});
