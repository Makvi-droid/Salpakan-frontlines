...
const ABILITY_NAME = "Supreme Charge";
const ABILITY_DESC_IDLE =
  "Move up to 2 squares in any direction — straight or diagonal — in a single turn.";
...
const styles = StyleSheet.create({
  ...
  iconPillCooldown: { borderColor: "#2A1A40", backgroundColor: "#100820" },
  iconText: {},
  abilityName: {
    color: "#C0A0FF",
  ...
  abilityNameCooldown: { color: "#3A2860" },
  readyPill: {
    backgroundColor: "#7040C0",
    paddingHorizontal: 8,
    paddingVertical: 2,
  },
  readyPillText: {
  ...
  descCooldown: { color: "#3A2860", opacity: 0.8 },
});
