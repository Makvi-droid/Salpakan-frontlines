...
import type { SecondLtRevealResult } from "../hooks/useSecondLtReveal";

// ─── Types ────────────────────────────────────────────────────────────────────

type Props = {
  event: SecondLtRevealResult | null;
...
const COMPARISON_CONFIG = {
  stronger: {
    label: "STRONGER",
    sublabel: "Outranks your 2nd Lieutenant",
    description:
      "This unit holds a higher rank than your 2nd Lieutenant. Engaging it directly is likely to result in elimination — proceed with caution or route around it.",
    icon: "⚔️",
    accentColor: "#D94040",
    accentDim: "#902828",
    accentGlow: "rgba(217, 64, 64, 0.28)",
    bgColor: "#120000",
    borderColor: "#D94040",
    pillBg: "#D94040",
    pillText: "#120000",
  ...
  weaker: {
    label: "WEAKER",
    sublabel: "Outranked by your 2nd Lieutenant",
    description:
      "This unit holds a lower rank than your 2nd Lieutenant. Your 2nd Lieutenant can challenge it directly with a strong chance of success.",
    icon: "🎯",
    accentColor: "#40A860",
    accentDim: "#286838",
    accentGlow: "rgba(64, 168, 96, 0.26)",
    bgColor: "#001208",
    borderColor: "#40A860",
    pillBg: "#40A860",
    pillText: "#001208",
...
export function SecondLtRevealModal({
  event,
  insets,
  width,
  rf,
  ...
  const cfg = event
    ? COMPARISON_CONFIG[event.comparison]
    : COMPARISON_CONFIG.weaker;
    ...
    <Modal visible={!!event} transparent animationType="none">
      <View style={[styles.overlay, overlayPadding]}>
        ...
        >
          ...
          >
            FIELD ASSESSMENT — STRENGTH COMPARISON
          </Text>
          ...
          >
            ...
            <Text style={[styles.intelNote, { fontSize: rf(9.5) }]}>
              ...
              . Only its relative strength was assessed.
            </Text>
          </Animated.View>
          ...
          >
            Your turn has been spent — the enemy now moves.
          </Text>
